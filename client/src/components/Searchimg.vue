        ...
        <div id="list" v-if="res.length > 0">
            <div class="column1" v-if="column1.length > 0" :style=style(1)>
                <div v-for="(el, index) in this.countImg" :key="index" className="item">
                    ...
                    <button v-show="user.authorised && user.is_verified" id="report" class="button__hov" @click="showReport(this.column1[(el - 1)].id)"><img
            ...
            <div class="column2" :style=style(2) v-if="column2.length > 0 & this.k >= 2">
                <div v-for="(el, index) in this.countImg" :key="index" className="item">
                    ...
                    <div v-if="el - 1 < this.column2.length">
                        ...
                        <button v-show="user.authorised && user.is_verified" id="report" class="button__hov" @click="showReport(this.column2[(el - 1)].id)"><img
                                src="../assets/img/svg/AlertCircle.svg" alt="" style="background: none;"></button>
            ...
            <div class="column3" :style=style(3) v-if="column3.length > 0 & this.k >= 3">
                <div v-for="(el, index) in this.countImg" :key="index" className="item">
                    ...
                    <div v-if="el - 1 < this.column3.length">
                        ...
                        <button v-show="user.authorised && user.is_verified" id="report" class="button__hov" @click="showReport(this.column3[(el - 1)].id)"><img
                                src="../assets/img/svg/AlertCircle.svg" alt="" style="background: none;"></button>
            ...
            <div class="column4" :style=style(4) v-if="column4.length > 0 & this.k >= 4">
                <div v-for="(el, index) in this.countImg" :key="index" className="item">
                    ...
                    <div v-if="el - 1 < this.column4.length">
                        ...
                        <button v-show="user.authorised && user.is_verified" id="report" class="button__hov" @click="showReport(this.column4[(el - 1)].id)"><img
                                src="../assets/img/svg/AlertCircle.svg" alt="" style="background: none;"></button>
