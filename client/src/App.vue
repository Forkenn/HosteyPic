  ...
  <body>
    ...
    <div class="page">
      ...
      <div class="wrapper__searchbar">
        <div class="searchbar">
          <div class="input">
            <input v-model="serach" v-on:keyup.enter="loadImg" placeholder="Напишите здесь для поиска..." id="idSearch">
          </div>
          <div class="searchbar__icon">

            <img src="../src/assets/img/svg/searchicon.svg" @click="loadImg" alt="">
          </div>
        </div>
      </div>
